...
local BossDropdown = BossSection:AddDropdown("SelectedBosses", {
    Title = "Select Bosses",
    Description = "Select which bosses should be summoned automatically.",
...
BossSection:AddToggle("AutoSummonBosses", {
    ...
    Description = "Cycles through the selected bosses using the game's SummonBoss remote.",
    Default = false,
    Callback = function(value)
...
BossSection:AddButton({
    Title = "Summon Selected Once",
    Description = "Attempts to summon every currently selected boss one time.",
    Callback = function()
        local attempted = 0
...
BossSection:AddButton({
    ...
    Description = "Scans BossSummoner.BossList again. Inset and Outset are ignored.",
    Callback = function()
...
notify(
    App.Name,
    "Capybaras Vs Plants hub loaded • Auto Buy + Boss Summoner + Anti AFK ready.",
    5
)
